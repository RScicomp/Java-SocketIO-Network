...
//This is what we send HELLO messages through - RG
public class SOSPFPacket implements Serializable {
  ...
  //simulated IP address
  public String neighborID; //neighbor's simulated IP address. How is this different from the dstIP? Is it the next router to be sent?
